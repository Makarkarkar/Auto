...
namespace Auto.FindVehicleEngine {
  public static partial class FindVehicle
  {
    ...
    /// <summary>Base class for server-side implementations of FindVehicle</summary>
    [grpc::BindServiceMethod(typeof(FindVehicle), "BindService")]
    public abstract partial class FindVehicleBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::Auto.FindVehicleEngine.FindVehicleReply> GetVehicle(global::Auto.FindVehicleEngine.FindVehicleRequest request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(FindVehicleBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, FindVehicleBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_GetVehicle, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Auto.FindVehicleEngine.FindVehicleRequest, global::Auto.FindVehicleEngine.FindVehicleReply>(serviceImpl.GetVehicle));
    }
